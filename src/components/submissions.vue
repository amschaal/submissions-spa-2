...
import advancedFilters from './search/advancedFilters.vue'
import saveSearch from './search/saveSearch.vue'
import loadSearch from './search/loadSearch.vue'
...
export default {
  ...
  methods: {
    getSearchQuery ({ pagination, filter}) {
      ...
      const mySubmissions = this.mySubmissions ? '&my_submissions' : ''
