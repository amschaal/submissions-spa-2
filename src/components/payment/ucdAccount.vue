<template>
  <div class="row">
    ...
    <q-banner class="bg-grey-3 q-mt-lg" v-if="value.payment_type == 'DaFIS'">
      ...
      For more information see <a target="_blank" rel="noopener noreferrer" href="https://aggieenterprise.ucdavis.edu/poetaf">https://aggieenterprise.ucdavis.edu/poetaf</a>.  Please note that the order of the fields is important.
    </q-banner>
  </div>
</template>
